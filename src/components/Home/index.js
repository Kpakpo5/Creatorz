...
const Home = ({ listCreator }) => (
  <Page>
    <p className="home-intro">Découvrez le savoir-faire artisanal made in France.<br />
      ...
      Cher visiteur, pensez à <Link to="/inscription/user" as="a">créer un compte</Link> si vous souhaitez laisser un commentaire à vos artisans préférés.<br />

      Vous êtes créateur et vous avez envie de faire découvrir vos créations artisanales ? <Link to="/inscription/creator" as="a">Inscrivez-vous!</Link><br />
